...
static char * sym_argstab[][5] = {{"symmetry","v",NULL},{"symmetry","-r","90",NULL},{"symmetry","-v",NULL},{"symmetry","98",NULL},{"symmetry","hello",NULL},{NULL}};
...
static char * rot_argstab[][5] = {{"rotate","-r","90",NULL},{"rotate","90",NULL},{"rotate","100",NULL},{"rotate","-r","10",NULL},{"rotate","0",NULL},
...
static char * trunc_argstab[][10] = {{"truncate",NULL},{"truncate","123","0","123","0",NULL},{"truncate","aze","100","zez","10",NULL},
				{"truncate","100","230",NULL},{NULL}};
static short trunc_err_tab[5] = {EINVA,0,ENUMV,EINVA,0};



static char * resize_tab[6] = {"resize 100 100","resize workspace","resize workspace 100","resize workspace 100 100","resize image",NULL};
static char * res_argstab[][6] = {{"resize","100","100",NULL},{"resize","workspace",NULL},{"resize","workspace","100",NULL},
				{"resize","workspace","100","100",NULL},{"resize","image",NULL},{NULL}};
static short res_err_tab[6] = {EINVA,EMSG,EMSG,0,EINVA,0};

static char * fill_tab[6] = {"fill 100 190 100 0","fill -a 100 100 100","fill -a 257 200 200 200","fill 200 200 200","fill its a joke",NULL};
static char * fill_argstab[][10] = {{"fill","100","190","100","0",NULL},{"fill","-a","100","100","100",NULL},
				{"fill","-a","257","200","200","200",NULL},{"fill","200","200","200",NULL},{"fill","its","a","joke",NULL},{NULL}};
static short fill_err_tab[6] = {0,EMSG,ENUMV,EMSG,ENUMV,0};

static char * replace_tab[5] = {"replace -a 100 200 123 12 123 239 12 9","replace -a 200 -m 20",
					"replace -a 200 250 30 200 22 11 9 10 -m 199","replace -a -200 250 30 200 22 11 9 10 -m 19",NULL};
static char * rep_argstab[][15] = {{"replace","-a","100","200","123","12","123","239","12","9",NULL},{"replace","-a","200","-m","20",NULL},
...
static char * save_argstab[][5] = {{"save","../../",NULL},{"save","./",NULL},{"save","-f","hjg","./",NULL},
				{"save","-f","png","./",NULL},{NULL}};
static short save_err_tab[5] = {0,0,EFFORM,0,0};

static char * load_tab[5] = {"load ./noexist.png","load image.png","load 900","load image.zzz",NULL};
static char * load_argstab[][5] = {{"load","./noexist.png",NULL},{"load","image.png",NULL},{"load","900",NULL},{"load","image.zzz",NULL},{NULL}};
...
static char * neg_argstab[][6] = {{"negative","-a","232",NULL},{"negative","-a",NULL},{"negative",NULL},{"negative",NULL},{NULL}};
static short neg_err_tab[6]={EINVA,0,0,0,EINVA,0};

static char * bnw_tab[6] = {"bnw -a 232","bnw -a ","bnw","bnw    ","bnw 223",NULL};
static char * bnw_argstab[][6] = {{"bnw","-a","232",NULL},{"bnw","-a",NULL},{"bnw",NULL},{"bnw",NULL},{"bnw","223",NULL},{NULL}};
...
static char * grey_argstab[][6] = {{"greyscale","-a","232",NULL},{"greyscale","-a",NULL},{"greyscale",NULL},{"greyscale",NULL},{"greyscale","223",NULL},{NULL}};
static short grey_err_tab[6] ={EINVA,0,EMSG,EMSG,EINVA,0};

static char * switch_tab[5] = {"switch_buffer zer","switch_buffer -1  ","switch_buffer","switch_buffer 3",NULL};
static char * switch_argstab[][5] = {{"switch_buffer","zer",NULL},{"switch_buffer","-1",NULL},{"switch_buffer",NULL},{"switch_buffer","3",NULL},{NULL}};
...
static char * listb_argstab[][5] = {{"list_buffer","-a",NULL},{"list_buffer","10",NULL},{"list_buffer",NULL},{NULL}};
...
static void test_parse_line(char ** tab , char* str){
	int i = 0 ;
	char ** tab2 = parse_line(str)->args;
	while( tab[i] != NULL){
			assert_string_equal(tab[i++]);
	}
}
